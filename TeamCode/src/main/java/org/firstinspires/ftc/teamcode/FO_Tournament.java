...
//                lState = LaunchState.Close;
        ...
        switch (armState) {
            case Bottom:
                if (gamepad2.a || gamepad2.x || gamepad2.y || gamepad2.b) {
                    if (motorSlideRight.getCurrentPosition() < 200) {
                        servoHOT.setPosition(0.67);
                        hState = HookState.In;
                ...
                } else if (gamepad2.a || gamepad2.x || gamepad2.y || gamepad2.b) {
            ...
            case RotateUp:
                if (motorSlideRight.getCurrentPosition()>480) {
                    ...
                    liftTimer.reset();
                    armState = ArmState.Change;
                }
                break;
            case Change:
                if (motorSlideRight.getCurrentPosition()>900) {
                    if (gamepad2.a) {
                        motorSlideRight.setTargetPosition(250);
                        motorSlideLeft.setTargetPosition(250);
                        motorSlideRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        motorSlideLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        motorSlideRight.setVelocity(1000);
                        motorSlideLeft.setVelocity(1000);
                        ...
                        motorSlideRight.setTargetPosition(750);
                        motorSlideLeft.setTargetPosition(750);
                        motorSlideRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        motorSlideLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        motorSlideRight.setVelocity(1000);
                        motorSlideLeft.setVelocity(1000);
