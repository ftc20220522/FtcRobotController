...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double ticksPerRev = Meet2DriveConstants.TICKS_PER_REV;
        public double maxRpm = Meet2DriveConstants.MAX_RPM;
        public boolean runUsingEncoder = Meet2DriveConstants.RUN_USING_ENCODER;
        public double motorP = Meet2DriveConstants.MOTOR_VELO_PID.p;
        public double motorI = Meet2DriveConstants.MOTOR_VELO_PID.i;
        public double motorD = Meet2DriveConstants.MOTOR_VELO_PID.d;
        public double motorF = Meet2DriveConstants.MOTOR_VELO_PID.f;
        public double wheelRadius = Meet2DriveConstants.WHEEL_RADIUS;
        public double gearRatio = Meet2DriveConstants.GEAR_RATIO;
        public double trackWidth = Meet2DriveConstants.TRACK_WIDTH;
        public double kV = Meet2DriveConstants.kV;
        public double kA = Meet2DriveConstants.kA;
        public double kStatic = Meet2DriveConstants.kStatic;
        public double maxVel = Meet2DriveConstants.MAX_VEL;
        public double maxAccel = Meet2DriveConstants.MAX_ACCEL;
        public double maxAngVel = Meet2DriveConstants.MAX_ANG_VEL;
        public double maxAngAccel = Meet2DriveConstants.MAX_ANG_ACCEL;
        ...
        public RevHubOrientationOnRobot.LogoFacingDirection LOGO_FACING_DIR = Meet2DriveConstants.LOGO_FACING_DIR;
        public RevHubOrientationOnRobot.UsbFacingDirection USB_FACING_DIR = Meet2DriveConstants.USB_FACING_DIR;
